...
// Server-rendered tile grid of media assets attached to the staff member.
// Image thumbnails are pre-resolved upstream (page.tsx) and threaded through
// as `displayUrlByAssetId`. Non-image tiles render mime icons; their
    ...
    return (
      ...
      >
        ...
        <p className="mx-auto mt-s2 max-w-sm t-body-sm text-ink-3">
          Upload photos and documents to keep this staff member&apos;s records
          in one place.
        </p>
