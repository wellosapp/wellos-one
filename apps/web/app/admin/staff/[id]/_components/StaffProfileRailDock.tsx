...
// "Coming soon" title. Hooks land in follow-up tickets.

export function StaffProfileRailDock() {
  const buttons = [
    { key: 'more', label: 'More actions', Icon: MoreIcon },
    { key: 'message', label: 'Message staff', Icon: MessageIcon },
    { key: 'favorite', label: 'Favorite staff', Icon: StarIcon },
  ];
